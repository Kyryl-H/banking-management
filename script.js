...
const headerConsover = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  rootMargin: `-${navHeight}px`,
});
headerConsover.observe(header);
...
const loadin = function (entries, observe) {
  const [entry] = entries;
...
const imgObsorver = new IntersectionObserver(loadin, {
  root: null,
  threshold: 0,
  rootMargin: '200px',
});

imgTarget.forEach(img => imgObsorver.observe(img));
// slider
